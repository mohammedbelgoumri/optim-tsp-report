\afterpage{
  ...
  \end{minipage}\hfill\\
  \vspace{20mm}
  {\large \bfseries 2ème Année Cycle Supérieur (2CS)}\\[0.5cm]
  {\large \bfseries Optimisation combinatoire}\\[0.5cm]
  {\large \bfseries{2021 - 2022} \\ }
  \vspace{10mm}
  % Title
  \rule{\linewidth}{0.3mm} \\[0.4cm]
  { \huge \bfseries Utilisation des méthodes méta-heuristiques pour l'optimisation}
  { \Large\bfseries Application: le problème du voyageur du commerce\\[0.4cm] }
