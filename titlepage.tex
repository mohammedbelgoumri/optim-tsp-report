\afterpage{
  ...
  \end{minipage}\hfill\\
  \vspace{20mm}
  {\large \bfseries Deuxième Année du Cycle Supérieur (2CS)}\\[0.5cm]
  {\large \bfseries Combinatorial Optimisation Assignement Report}\\[0.5cm]
  % {\large \bfseries{2021 - 2022} \\}
  \vspace{10mm}
  % Title
  \rule{\linewidth}{0.3mm} \\[0.4cm]
  { \huge \bfseries The Traveling Salesman Problem\\}
