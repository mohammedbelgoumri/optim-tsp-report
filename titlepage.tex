\afterpage{
  ...
  \end{minipage}\hfill\\
  \vspace{20mm}
  {\large \bfseries 2nd Year of Higher Cycle}\\[0.5cm]
  % {\large \bfseries Combinatorial Optimisation}\\[0.5cm]
  {\large \bfseries{2021 - 2022} \\ }
  \vspace{10mm}
  % Title
  \rule{\linewidth}{0.3mm} \\[0.4cm]
  { \huge \bfseries Exact and Approximate Algorithms for Combinatorial Optimisation,\\}
  { \Large\bfseries The Traveling Salesman Problem as An Application\\[0.4cm]}
